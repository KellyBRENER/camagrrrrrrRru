...
return [
    ...
    'profil' => ['controller' => 'AuthController', 'method' => 'profil', 'public' => false],
    'notifications_update' => ['controller' => 'AuthController', 'method' => 'updateNotifications', 'public' => false],
    'profile_update' => ['controller' => 'AuthController', 'method' => 'updateProfile', 'public' => false],
    'password_update' => ['controller' => 'AuthController', 'method' => 'updatePassword', 'public' => false],
    ...
    'forgot_password' => ['controller' => 'AuthController', 'method' => 'forgotPassword', 'public' => true],
    'reset_password' => ['controller' => 'AuthController', 'method' => 'resetPassword', 'public' => true],
